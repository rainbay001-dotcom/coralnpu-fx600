...
module SCore(
  ...
  output         io_rvvcore_async_frd_ready,
  input          io_rvvcore_async_frd_valid,
  input  [4:0]   io_rvvcore_async_frd_bits_addr,
  input  [31:0]  io_rvvcore_async_frd_bits_data,
  ...
  input          io_rvvcore_rd_rob2rt_o_0_last_uop_valid,
                 io_rvvcore_rd_rob2rt_o_1_valid,
  ...
  input          io_rvvcore_rd_rob2rt_o_1_last_uop_valid,
                 io_rvvcore_rd_rob2rt_o_2_valid,
  ...
  input          io_rvvcore_rd_rob2rt_o_2_last_uop_valid,
                 io_rvvcore_rd_rob2rt_o_3_valid,
  ...
  wire        _dispatch_io_frs1Read_0_valid;
  wire [4:0]  _dispatch_io_frs1Read_0_addr;
  wire        _dispatch_io_frs1Read_1_valid;
  wire        _dispatch_io_frs1Read_2_valid;
  wire        _dispatch_io_frs1Read_3_valid;
  ...
  wire        _dispatch_io_lsu_0_bits_vm;
  ...
  wire [4:0]  _dispatch_io_lsu_1_bits_bit24To20;
  wire        _dispatch_io_lsu_1_bits_vm;
  ...
  wire [4:0]  _dispatch_io_lsu_2_bits_bit24To20;
  wire        _dispatch_io_lsu_2_bits_vm;
  ...
  wire [4:0]  _dispatch_io_lsu_3_bits_bit24To20;
  wire        _dispatch_io_lsu_3_bits_vm;
  ...
  wire        fRegfile_io_write_ports_1_valid =
    _floatCore_io_write_ports_1_valid | io_rvvcore_async_frd_valid;
  wire [4:0]  fRegfile_io_write_ports_1_addr =
    _floatCore_io_write_ports_1_valid
      ? _floatCore_io_write_ports_1_addr
      : io_rvvcore_async_frd_bits_addr;
  wire        writeMask_2 = _bru_0_io_taken_valid | _bru_1_io_taken_valid;
  reg  [31:0] rvvFrsReg_0;
  reg  [31:0] rvvFrsReg_1;
  reg  [31:0] rvvFrsReg_2;
  reg  [31:0] rvvFrsReg_3;
  ...
  always @(posedge clock) begin
    if (_dispatch_io_frs1Read_0_valid)
      rvvFrsReg_0 <=
        {_fRegfile_io_read_ports_0_data_sign,
         _fRegfile_io_read_ports_0_data_exponent,
         _fRegfile_io_read_ports_0_data_mantissa};
    if (_dispatch_io_frs1Read_1_valid)
      rvvFrsReg_1 <=
        {_fRegfile_io_read_ports_0_data_sign,
         _fRegfile_io_read_ports_0_data_exponent,
         _fRegfile_io_read_ports_0_data_mantissa};
    if (_dispatch_io_frs1Read_2_valid)
      rvvFrsReg_2 <=
        {_fRegfile_io_read_ports_0_data_sign,
         _fRegfile_io_read_ports_0_data_exponent,
         _fRegfile_io_read_ports_0_data_mantissa};
    if (_dispatch_io_frs1Read_3_valid)
      rvvFrsReg_3 <=
        {_fRegfile_io_read_ports_0_data_sign,
         _fRegfile_io_read_ports_0_data_exponent,
         _fRegfile_io_read_ports_0_data_mantissa};
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        csr_io_rs1_REG = _RANDOM[3'h0][0];
        stepTriggeredReg = _RANDOM[3'h0][1];
        rvvFrsReg_0 = {_RANDOM[3'h0][31:2], _RANDOM[3'h1][1:0]};
        rvvFrsReg_1 = {_RANDOM[3'h1][31:2], _RANDOM[3'h2][1:0]};
        rvvFrsReg_2 = {_RANDOM[3'h2][31:2], _RANDOM[3'h3][1:0]};
        rvvFrsReg_3 = {_RANDOM[3'h3][31:2], _RANDOM[3'h4][1:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        csr_io_rs1_REG = 1'h0;
        stepTriggeredReg = 1'h0;
  ...
  DispatchV2 dispatch (
    ...
    .io_frs1Read_0_valid               (_dispatch_io_frs1Read_0_valid),
    .io_frs1Read_0_addr                (_dispatch_io_frs1Read_0_addr),
    .io_frs1Read_1_valid               (_dispatch_io_frs1Read_1_valid),
    .io_frs1Read_2_valid               (_dispatch_io_frs1Read_2_valid),
    .io_frs1Read_3_valid               (_dispatch_io_frs1Read_3_valid),
    ...
    .io_lsu_0_bits_vm                  (_dispatch_io_lsu_0_bits_vm),
    ...
    .io_lsu_1_bits_bit24To20           (_dispatch_io_lsu_1_bits_bit24To20),
    .io_lsu_1_bits_vm                  (_dispatch_io_lsu_1_bits_vm),
    ...
    .io_lsu_2_bits_bit24To20           (_dispatch_io_lsu_2_bits_bit24To20),
    .io_lsu_2_bits_vm                  (_dispatch_io_lsu_2_bits_vm),
    ...
    .io_lsu_3_bits_bit24To20           (_dispatch_io_lsu_3_bits_bit24To20),
    .io_lsu_3_bits_vm                  (_dispatch_io_lsu_3_bits_vm),
  ...
  LsuV3 lsu (
    ...
    .io_req_0_bits_vm                     (_dispatch_io_lsu_0_bits_vm),
    ...
    .io_req_1_bits_bit24To20              (_dispatch_io_lsu_1_bits_bit24To20),
    .io_req_1_bits_vm                     (_dispatch_io_lsu_1_bits_vm),
    ...
    .io_req_2_bits_bit24To20              (_dispatch_io_lsu_2_bits_bit24To20),
    .io_req_2_bits_vm                     (_dispatch_io_lsu_2_bits_vm),
    ...
    .io_req_3_bits_bit24To20              (_dispatch_io_lsu_3_bits_bit24To20),
    .io_req_3_bits_vm                     (_dispatch_io_lsu_3_bits_vm),
    .io_busPort_addr_0                    (_regfile_io_busPort_addr_0),
    .io_busPort_addr_1                    (_regfile_io_busPort_addr_1),
    .io_busPort_addr_2                    (_regfile_io_busPort_addr_2),
    .io_busPort_addr_3                    (_regfile_io_busPort_addr_3),
    ...
    .io_rvvState_bits_vl                  (io_rvvcore_configState_bits_vl),
    .io_rvvState_bits_vstart              (io_rvvcore_configState_bits_vstart),
  ...
  RetirementBuffer retirement_buffer (
    ...
    .io_writeDataFloat_1_valid                (fRegfile_io_write_ports_1_valid),
    .io_writeDataFloat_1_bits_addr            (fRegfile_io_write_ports_1_addr),
    ...
    .io_writeDataVector_1_valid               (io_rvvcore_rd_rob2rt_o_1_valid),
    ...
    .io_writeDataVector_2_valid               (io_rvvcore_rd_rob2rt_o_2_valid),
    ...
    .io_writeDataVector_3_valid               (io_rvvcore_rd_rob2rt_o_3_valid),
  ...
  FRegfile fRegfile (
    ...
    .io_read_ports_0_valid
      (io_dm_float_rs_valid | _floatCore_io_read_ports_0_valid
       | _dispatch_io_frs1Read_0_valid),
    .io_read_ports_0_addr
      (io_dm_float_rs_valid
         ? io_dm_float_rs_addr
         : _floatCore_io_read_ports_0_valid
             ? _floatCore_io_read_ports_0_addr
             : _dispatch_io_frs1Read_0_valid ? _dispatch_io_frs1Read_0_addr : 5'h0),
    .io_read_ports_0_data_mantissa  (_fRegfile_io_read_ports_0_data_mantissa),
    .io_read_ports_0_data_exponent  (_fRegfile_io_read_ports_0_data_exponent),
    .io_read_ports_0_data_sign      (_fRegfile_io_read_ports_0_data_sign),
    .io_read_ports_1_valid          (_floatCore_io_read_ports_1_valid),
  ...
  Arbiter5_RegfileWriteDataIO arb (
    ...
    .io_in_4_ready     (io_dm_scalar_rd_ready),
    .io_in_4_valid     (io_dm_scalar_rd_valid),
    .io_in_4_bits_addr (io_dm_scalar_rd_bits_addr),
    .io_in_4_bits_data (io_dm_scalar_rd_bits_data),
  ...
  assign io_rvvcore_frs_0 = rvvFrsReg_0;
  assign io_rvvcore_frs_1 = rvvFrsReg_1;
  assign io_rvvcore_frs_2 = rvvFrsReg_2;
  assign io_rvvcore_frs_3 = rvvFrsReg_3;
  assign io_rvvcore_async_frd_ready = ~_floatCore_io_write_ports_1_valid;
endmodule
