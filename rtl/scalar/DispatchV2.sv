...
module DispatchV2(
  ...
  wire        isJump_0 =
    ...
    | decodedInsts_0_mret | _slot0Interlock_T_48 | decodedInsts_0_wfi
  ...
  wire        isLsu_0 =
    ...
    | decodedInsts_floatValid & _io_float_valid_T_3;
  ...
  wire        coreIdle =
    io_scoreboard_regd == 32'h0 & io_fscoreboard == 32'h0 & ~io_lsuActive;
  wire        tryDispatch =
    ...
    & ~((_slot0Interlock_T_48 | decodedInsts_0_wfi | decodedInsts_0_mpause
  ...
  wire        io_lsu_0_valid_0 =
    ...
    & (decodedInsts_0_lb | decodedInsts_0_lh | decodedInsts_0_lw | decodedInsts_0_lbu
       ...
       | decodedInsts_0_flushall | _lsu_valid_T_39);
  wire        csr_valid =
  ...
  wire        tryDispatch_1 =
    ...
    & ~(_slot0Interlock_T_48 | decodedInsts_0_wfi | decodedInsts_0_mpause
        ...
        | decodedInsts_0_csrrc | decodedInsts_floatValid) & {3'h0, isLsu_0} < _GEN_20
    & (|{decodedInsts_1_lui,
  ...
  wire        tryDispatch_2 =
    ...
    & {((decodedInsts_2_jalr | _rdMark_valid_T_49 | decodedInsts_2_lw | decodedInsts_2_lbu
    ...
    & ~(_slot0Interlock_T_48 | decodedInsts_0_wfi | decodedInsts_0_mpause
        | decodedInsts_0_flushat | decodedInsts_0_flushall | _io_rs2Set_0_valid_T_1
        | decodedInsts_0_csrrc | decodedInsts_floatValid) & _isLsuCount_T_1 < _GEN_20
    & (|{decodedInsts_2_lui,
  ...
  wire        tryDispatch_3 =
    ...
    & {((decodedInsts_3_jalr | _rdMark_valid_T_70 | decodedInsts_3_lw | decodedInsts_3_lbu
    ...
    & ~(_slot0Interlock_T_48 | decodedInsts_0_wfi | decodedInsts_0_mpause
        | decodedInsts_0_flushat | decodedInsts_0_flushall | _io_rs2Set_0_valid_T_1
        | decodedInsts_0_csrrc | decodedInsts_floatValid) & _isLsuCount_T_1
    + {3'h0,
       _rdMark_valid_T_49 | decodedInsts_2_lw | decodedInsts_2_lbu | decodedInsts_2_lhu
         | _io_rs2Read_2_valid_T_25 | decodedInsts_2_sw} < _GEN_20
    & (|{decodedInsts_3_lui,
  ...
  assign io_rs1Read_0_valid =
    ...
    & (_io_rs2Read_0_valid_T_1 | decodedInsts_0_blt | decodedInsts_0_bge
       ...
       | _io_rs2Read_0_valid_T_34 | decodedInsts_0_mulhsu | decodedInsts_0_mulhu
       | _io_rs2Read_0_valid_T_38 | decodedInsts_0_rem | decodedInsts_0_remu
       | decodedInsts_0_jalr | _io_rs1Read_0_valid_T_55);
  ...
  assign io_rdMark_0_valid =
    ...
    & (_rdMark_valid_T_5 | decodedInsts_0_lw | decodedInsts_0_lbu | decodedInsts_0_lhu)
    | io_csr_valid_0 | dispatched_7 & decodedInsts_float_scalar_rd | io_bru_0_valid_0
  ...
  assign io_rdMark_flt_valid =
    dispatched_7 & ~decodedInsts_float_scalar_rd | dispatched_4 & decodedInsts_floatValid
  ...
  assign io_lsu_0_bits_op =
    ...
    | (decodedInsts_0_flushall ? 5'hA : 5'h0) | (_lsu_valid_T_39 ? 5'hC : 5'h0);
