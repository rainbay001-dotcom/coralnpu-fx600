...
module Csr(
  ...
  wire [31:0] rdata =
    ...
    | (mstatusEn ? {24'h38, mstatus_mpie, 3'h0, mstatus_mie, 3'h0} : 32'h0)
    | (misaEn ? 32'h40001120 : 32'h0) | (mieEn ? mie : 32'h0)
    ...
    | (kscm4En ? 32'h44141A10 : 32'h0) | (tdata1En ? tdata1_data : 32'h0)
  ...
  wire [2:0]  _GEN = _frmBypass_T_15[2:0] & frm;
  wire [7:0]  _GEN_0 = _frmBypass_T_15[7:0] & {frm, fflags};
  ...
  wire        _GEN_1 = req_valid & mstatusEn;
  wire        is_csr_write =
    ...
    if (reset) begin
      ...
      mstatus_mie <=
        io_bru_in_mode_valid
          ? mstatus_mpie
          : ~io_bru_in_mcause_valid & (_GEN_1 ? wdata[3] : mstatus_mie);
      mstatus_mpie <=
        io_bru_in_mode_valid
        | (io_bru_in_mcause_valid ? mstatus_mie : _GEN_1 ? wdata[7] : mstatus_mpie);
      if (req_valid & mieEn)
